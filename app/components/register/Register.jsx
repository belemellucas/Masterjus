...
const Register = ({ onRegister }) => {
    ...
    <form onSubmit={handleSubmit}>
      <div className="relative h-auto lg:h-[416px] mx-auto top-[111px]">
        <div className="relative w-full lg:w-[1170px] h-auto lg:h-[314px] mx-auto bg-[#929090] rounded-[10px] p-4 lg:p-0">
          ...
          {/* E-mail */}
          <label className="block lg:absolute lg:w-[48.65px] lg:h-[21px] lg:left-[600px] lg:top-[22px] font-poppins font-bold text-[14px] leading-[21px] text-[#212529] mt-2 lg:mt-0">
            E-mail
          </label>
          <input
            type="text"
          ...
          {/* Tel. Celular */}
          <label className="block lg:absolute lg:w-[80.76px] lg:h-[21px] lg:left-[890px] lg:top-[22px] font-poppins font-bold text-[14px] leading-[21px] text-[#212529] mt-2 lg:mt-0">
            Tel. Celular
          </label>
          <input
            type="text"
          ...
          {/* Senha */}
          <label className="block lg:absolute lg:w-[45.97px] lg:h-[21px] lg:left-[20px] lg:top-[100px] font-poppins font-bold text-[14px] leading-[21px] text-[#212529] mt-2 lg:mt-0">
            Senha
          </label>
          <input
            type="password"
          ...
          {/* Confirmar Senha */}
          <label className="block lg:absolute lg:w-[123.48px] lg:h-[21px] lg:left-[310px] lg:top-[100px] font-poppins font-bold text-[14px] leading-[21px] text-[#212529] mt-2 lg:mt-0">
            Confirmar Senha
          </label>
          <input
            type="password"
          ...
          {/* CEP */}
          <label className="block lg:absolute lg:w-[27.34px] lg:h-[21px] lg:left-[600px] lg:top-[100px] font-poppins font-bold text-[14px] leading-[21px] text-[#212529] mt-2 lg:mt-0">
            CEP
          </label>
          <input
            type="text"
          ...
          {/* Endereço */}
          <label className="block lg:absolute lg:w-[67.46px] lg:h-[21px] lg:left-[890px] lg:top-[100px] font-poppins font-bold text-[14px] leading-[21px] text-[#212529] mt-2 lg:mt-0">
            Endereço
          </label>
          <input
            type="text"
          ...
          {/* Número */}
          <label className="block lg:absolute lg:w-[58.71px] lg:h-[21px] lg:left-[20px] lg:top-[178px] font-poppins font-bold text-[14px] leading-[21px] text-[#212529] mt-2 lg:mt-0">
            Número
          </label>
          <input
            type="text"
            ...
            onChange={handleChange}
            placeholder="Número"
            className="block w-full lg:w-[10%] lg:absolute lg:top-[201px] lg:left-[21px] bg-white border border-[#CED4DA] rounded-[4px] p-2 mt-2 lg:mt-0"
          />
  
          {/* Complemento */}
          <label className="block lg:absolute lg:w-[104.53px] lg:h-[21px] lg:left-[165px] lg:top-[178px] font-poppins font-bold text-[14px] leading-[21px] text-[#212529] mt-2 lg:mt-0">
            Complemento
          </label>
          <input
  type="text"
  ...
  className="block w-full lg:w-[10%] lg:absolute lg:top-[201px] lg:left-[166px] bg-white border border-[#CED4DA] rounded-[4px] p-2 mt-2 lg:mt-0"
/>
...
<select
  ...
  onChange={handleChange}
  className="block w-full lg:w-[25%] lg:absolute lg:top-[201px] lg:left-[311px] bg-white border border-[#CED4DA] rounded-[4px] p-2 mt-2 lg:mt-0"
>
  <option>Acre</option>
...
<select
  ...
  onChange={handleChange}
  className="block w-full lg:w-[25%] lg:absolute lg:top-[201px] lg:left-[601px] bg-white border border-[#CED4DA] rounded-[4px] p-2 mt-2 lg:mt-0"
>
...
>
  ...
  {/* Add other neighborhoods as options */}
          ...
          <div className="block lg:absolute w-full lg:w-[355.66px] lg:h-[21px] lg:left-[20px] lg:top-[256px] flex items-center mt-2 lg:mt-0">
