...
const Search = () => {
    ...
    <input
        className="peer block w-full mx-4 mt-2 px-3 py-2 rounded-md border text-gray-200 bg-[#0402A7] border-gray-200 pl-10 text-sm outline-2 placeholder:text-gray-400"
